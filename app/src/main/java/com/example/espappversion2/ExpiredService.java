...
public class ExpiredService extends IntentService {
    private User currentUser;
    private String CHANNEL_ID = "EXPIRY_NOTIFICATION2";

    public ExpiredService() {
        super("ExpiredService");  // allegedly deprecated, if it works, then it can respectfully go away :)
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.i("ExpiredService", "Service running");
    }
    ...
    private void createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "Expired Notification";
            String description = "Expired Notification";
